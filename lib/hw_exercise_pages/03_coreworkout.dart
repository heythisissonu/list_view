...
import 'final_ui_card.dart';
  // Import the WorkoutDetailPage class

class CoreWorkoutPage extends StatefulWidget {
  final String title;
  final String description;

  const CoreWorkoutPage({super.key, required this.title, required this.description});
...
class _FullBodyPageState extends State<CoreWorkoutPage> {
      ...
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final data = coreExercises[index];
