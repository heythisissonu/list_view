...
class UpperBodyPageShoulders extends StatefulWidget {
  final String title;
  final String description;

  // ignore: prefer_const_constructors_in_immutables
  UpperBodyPageShoulders({super.key, required this.title, required this.description});


 @override
  // ignore: library_private_types_in_public_api
  _UpperBodyPageShouldersState createState() => _UpperBodyPageShouldersState();
}

class _UpperBodyPageShouldersState extends State<UpperBodyPageShoulders> {
      ...
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final data = shoulderexercises[index];
