...
class UpperBodyPageTriceps extends StatefulWidget {
  final String title;
  final String description;

 // ignore: prefer_const_constructors_in_immutables
  UpperBodyPageTriceps({super.key, required this.title, required this.description});


 @override
  // ignore: library_private_types_in_public_api
  _UpperBodyPageTricepsState createState() => _UpperBodyPageTricepsState();
}

class _UpperBodyPageTricepsState extends State<UpperBodyPageTriceps> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          itemCount: tricepExercises.length,
          itemBuilder: (context, index) {
            final data = tricepExercises[index];
