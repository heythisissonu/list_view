...
class UpperBodyPageChest extends StatefulWidget {
  final String title;
  final String description;

 // ignore: prefer_const_constructors_in_immutables
  UpperBodyPageChest({super.key, required this.title, required this.description});


 @override
  // ignore: library_private_types_in_public_api
  _UpperBodyPageChestState createState() => _UpperBodyPageChestState();
}

class _UpperBodyPageChestState extends State<UpperBodyPageChest> {
